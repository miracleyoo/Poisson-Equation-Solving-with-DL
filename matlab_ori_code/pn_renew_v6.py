...
def pn_renew_v6(particles=None, valley=None, Ttot=None, dx=None, dy=None, nx1=None, ny1=None, max_particles=None,
    ...
    temp3 = valley[:, 1] == 3
    temp4 = valley[:, 1] == 4
    temp1 = temp1*arange(1, max_particles)
    temp2 = temp2*arange(1, max_particles)
    temp3 = temp3*arange(1, max_particles)
    temp4 = temp4*arange(1, max_particles)
    temp1 = temp1*(temp1 != 0)
    temp2 = temp2*(temp2 != 0)
    temp3 = temp3*(temp3 != 0)
    temp4 = temp4*(temp4 != 0)
    ...
    pei = pei*arange(1, max_particles)
    pei = pei*(pei != 0)
    ...
    v9i = v9i*arange(1, max_particles)
    v9i = v9i*(v9i != 0)
    v9_count = 1
        ...
        if p_delta(i) < 0:
            ...
            if p_delta(i) > 0:
                ...
                if i == 1:
                    ...
                    psi_temp = psi_temp*arange(1, length(ph))
    ...
    nei = nei*arange(1, max_particles)
    nei = nei*(nei != 0)
    ...
    npi = npi*arange(1, max_particles)
    npi = npi*(npi != 0)
        ...
        if n_delta(i) < 0:
            ...
            if n_delta(i) > 0:
                ...
                if i == 1:
                    ...
                    pdi_temp = pdi_temp*arange(1, length(nei))
                ...
                for j in arange(1, n_dif).reshape(-1):
                    ...
                    valley[index2] = 9
                    pdi_temp[temp_index] = []
    return particles, valley, p_added, n_added, number