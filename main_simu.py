...
Vp_all = [0.05*i for i in range(57)][38:] #[2.4, 2.6, 2.5, 2.7]#[0, 0.3, 0.6, 0.9, 1.1, 1.2, 1.3, 1.6, 1.9, 2.2, 2.5, 2.7]#, 1.8, 1.5, 1.2, 0.8, 0.4, 0] #2.0, 2.5, 2.7, #, 1.2, 0.5, 0.8, 1, 1.6, 1.8, 2.25, 2.7]
Vn_all = [0]
USE_DL = True
